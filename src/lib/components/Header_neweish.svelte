<header class="sticky top-0 z-40 w-full border-b bg-white/95 backdrop-blur">
  <div class="container mx-auto flex h-16 items-center justify-between px-4">
    ...
    <nav class="hidden md:flex gap-6">
      ...
      <a
        href="#certifications"
        class="text-sm font-medium relative group nav-link"
      >
        <span
          class="transition-colors duration-300 group-hover:text-primary-600"
          >Certifications</span
      ...
      <a href="#contact" class="text-sm font-medium relative group nav-link">
        <span
          class="transition-colors duration-300 group-hover:text-primary-600"
          >Contact</span
        >
  ...
  <div
    id="mobile-menu"
    class="md:hidden absolute top-16 left-0 right-0 bg-white border-b border-gray-200 py-4 px-4 shadow-md hidden"
  >

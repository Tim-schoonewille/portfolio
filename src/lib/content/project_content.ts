...
<div class="prose max-w-none text-gray-600">
  <p class="mb-4 tracking-tight font-medium">
    Voor mijn portfolio heb ik een applicatie ontwikkeld die fysieke bonnetjes
    digitaliseert. Dit project ontstond uit een persoonlijke behoefte: ik
  ...
  <p class="mb-4">
    ...
    probleemoplossing in de praktijk. Wil je meer weten? Neem gerust contact op!
  </p>
</div>`,
  },
  {

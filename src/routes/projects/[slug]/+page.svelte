<script lang="ts">
  ...
  import { project_contents } from "$lib/content/project_content";
  ...
  let content = $derived<string | undefined>(
    project_contents.find((content) => content.slug === slug)?.content
  );
</script>
      ...
      <div class="container mx-auto px-4 md:px-6">
        ...
        >
          <div class="space-y-2">
            ...
            <p class="max-w-[700px] text-gray-500 md:text-lg"></p>
          </div>
        </div>
